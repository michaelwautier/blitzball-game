...
): PlayerDef => ({ id, name, natural, stats: s, techniques })
...
export const BESAID_AUROCHS: TeamDef = {
  ...
  roster: [
    ...
    player('letty', 'Letty', 'LD', stats(180, 7, 9, 9, 5, 9, 5, 1), ['venom-tackle']),
    player('jassu', 'Jassu', 'RD', stats(190, 7, 10, 8, 7, 10, 4, 1), ['wither-tackle']),
    player('tidus', 'Tidus', 'MF', stats(200, 12, 8, 4, 5, 2, 12, 1), ['jecht-shot', 'wither-pass']),
    player('wakka', 'Wakka', 'LF', stats(250, 8, 14, 10, 6, 8, 14, 1), ['venom-shot', 'venom-pass']),
    player('datto', 'Datto', 'RF', stats(160, 10, 6, 5, 8, 4, 6, 1), ['wither-pass']),
...
export const LUCA_GOERS: TeamDef = {
  ...
  roster: [
    ...
    player('doram', 'Doram', 'LD', stats(200, 9, 10, 12, 6, 11, 5, 1), ['venom-tackle']),
    player('balgerda', 'Balgerda', 'RD', stats(205, 9, 10, 11, 7, 12, 6, 1), ['wither-tackle']),
    player('bickson', 'Bickson', 'MF', stats(240, 13, 12, 8, 8, 5, 16, 1), ['sphere-shot', 'nap-shot']),
    player('graav', 'Graav', 'LF', stats(230, 10, 11, 9, 7, 7, 12, 1), ['venom-shot']),
    player('abus', 'Abus', 'RF', stats(210, 11, 9, 7, 9, 6, 10, 1), ['venom-pass']),
  ],
